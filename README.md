...
> **Note:** This is the published Google AI Studio application URL. If the Ideathon submission specifically requires a Cloud Run `.run.app` URL, use the actual Cloud Run service URL from Google Cloud Console instead.
